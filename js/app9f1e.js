...
function stopPage() {
  null != reveal && (reveal.stopEvents(), (reveal = null)),
    ...
    null != journal && (journal.stopEvents(), (journal = null)),
    null != journalPost && (journalPost.stopEvents(), (journalPost = null));
}
  ...
  setTimeout(function () {
    ...
    Barba.Dispatcher.on("newPageReady", function () {
      window.ga &&
        ...
        gtag("config", "UA-120921934-1", { page_path: location.pathname });
    }),
    isMobile ||
      (ui.addEventListener("mouseenter", function (t) {
        documentBody.classList.contains("journal-post-page") &&
                  ...
                  .forEach(function (t) {
                    basicScroll
                      .create({
                        ...
                        direct: !0,
                        props: {
                          "perspective-origin-y": { from: "25%", to: "85%" },
                          "--perspective-origin-y": { from: "25%", to: "85%" },
                        },
                      })
                      .start();
                ...
                .forEach(function (t) {
                  ...
                  basicScroll
                    .create({
                      ...
                      direct: !0,
                      props: {
                        "transform-y": { from: e, to: i, timing: n },
                        "--transform-y": { from: e, to: i, timing: n },
                      },
                    })
                    .start();
      ...
      _createClass(e, [
        {
          ...
          value: function (t) {
            (this.documentBody = document.body),
              ...
              (this.journalContainer = document.querySelector(
                ".journal .container"
              )),
              (this.journalContent =
                ...
                .forEach(function (t) {
                  ...
                  basicScroll
                    .create({
                      ...
                      direct: !0,
                      props: {
                        "transform-x": { from: e, to: i, timing: n },
                        "--transform-x": { from: e, to: i, timing: n },
                      },
                    })
                    .start();
        ...
        },
        {
          ...
          value: function () {
            document.documentElement.clientWidth;
            (this.scrollOffset =
              this.journal.pageYOffset || this.journal.scrollTop),
              (this.scrollPercent =
                this.scrollOffset /
                  (this.scrollHeight - this.documentBody.offsetHeight) || 0),
              this.isMobile ||
